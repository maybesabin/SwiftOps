                ...
                <div className="flex items-center gap-4">
                    <div className="flex items-end gap-6">
                        <div className="flex flex-col items-center ml-6">
                            <div className="rounded-full dark:bg-white bg-black md:p-1.5 p-1"></div>
                            <div className="dark:bg-white bg-black md:h-28 h-20 w-0.5 -mt-1"></div>
                            <div className="rounded-full dark:bg-white bg-black md:p-4 p-3">
